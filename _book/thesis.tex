...
% Everything below added by CII
  ...
  properties.\footnote{More can be found on {[}6,9,20{]}.}
  ...
  we can rewrite it in the form {[}6,12,13,20,23,24{]}:
  \begin{align} \label{sde1}
  ...
  {[}6,24{]}. For practical uses you should write out a second-order
  ...
  whose values depend on the values of an underlying asset. {[}2,21,28{]}
  \begin{itemize}
  \item
  ...
  A stochastic process \(S_t\) is a geometric brownian motion\footnote{There
    ...
    about this process looking at {[}26{]}.} if its solution is described
  ...
  \end{align}
  \noindent
  Where \(dW_t\) is a Wiener process {[}2,7{]}, \(r\) is the risk free
  ...
  implemented in the R programming language {[}18{]} that we base on a
  ...
  {[}16{]} Most differential equations, deterministic or stochastic,
  ...
  1993 Steven Heston's paper {[}10{]} and is described below {[}5{]}:
  \begin{align}
  ...
  method {[}1,14{]} that coupled with the implicit Milstein scheme for the
  ...
  of the terminal stock price based on numerous papers {[}10{]}. The
  algorithm used to generate the model consists in four steps as follows:
  \begin{itemize}
  ...
  {[}14{]} C. Kahl, P. Jäckel, Fast strong approximation monte carlo
  ...
  {[}17{]} R.C. Merton, Theory of rational option pricing, The Bell
  ...
  {[}19{]} M. Romano, N. Touzi, Contingent claims and market completeness
  in a stochastic volatility model, Mathematical Finance. 7 (1997)
  399--412.
  
  \hypertarget{ref-rosenthal}{}
  {[}20{]} J.S. Rosenthal, A first look at rigorous probability theory,
  World Scientific Publishing Co Inc, 2006.
  
  \hypertarget{ref-salomao2011precificaccao}{}
  {[}21{]} M. de F. Salomão, Precificação de opções financeiras: Um estudo
  sobre os modelos de black scholes e garch, (2011).
  
  \hypertarget{ref-scott1996}{}
  {[}22{]} L. Scott, Simulating a multi-factor term structure model over
  ...
  {[}27{]} G.A. Willard, Calculating prices and sensitivities for
