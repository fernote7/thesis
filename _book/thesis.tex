...
% Everything below added by CII
  ...
  A stochastic process \(S_t\) is a geometric brownian motion\footnote{There
    ...
    about this process looking at {[}3{]}.} if its solution is described
  ...
  1993 Steven Heston's paper {[}19{]} and is described below {[}23{]}:
  \begin{align}
  ...
  language {[}24{]}. The Euler discretization brings approximation paths
  ...
  computation of \(\sqrt{V_t}\) impossible {[}25{]}. There are several
  ...
  {[}25{]} L.B. Andersen, Efficient simulation of the heston stochastic
