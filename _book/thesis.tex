...
% Everything below added by CII
  ...
  \end{align}
  \noindent
  Here \(W_t\) is a Wiener process {[}1,18{]}, \(r\) is the risk free rate
  ...
  and other models, like the GARCH\footnote{generalized autoregressive
    conditional heteroscedasticity. {[}19{]}} and SABR,\footnote{stochastic
    alpha, beta, rho. {[}21{]}} are considered standard smile models.
  \begin{figure}
  ...
  risk. The dynamics are described as follows {[}22,23{]}:
  \begin{align}
  \label{eq:cir}
  ...
  term structure{[}22{]}. Furthermore, this equation constitutes one of
  ...
  under the risk-neutral measure {[}23,24{]}:
  \begin{align}
  \label{eq:heston}
  ...
  \end{itemize}
  Examples of these two classes of problem can be found in {[}24{]}.
  ...
  for not small enough stepsizes {[}26{]}. A differential equation of the
  ...
  large positive constant {[}27{]}. A practical example of the stiff
  ...
  the more likely is to be stiff {[}26{]}.
  ...
  \(\mathbb{R} \left[\lambda \right] < 0\). The \emph{linear stability
  domain} \(\mathcal{D}\) is defined as the set of all numbers
  \(\Delta \lambda \in \mathbb{C}\) such that
  \(\lim_{n \to \infty} y_n = 0\), with \(\Delta > 0\) being the stepsize.
  ...
  Without entering all the details, for these we recommend {[}25,26,28{]},
  ...
  explanation of convergence we recommend consulting {[}29{]}.
  ...
  size adopted tends toward zero {[}30,31{]}. Moreover, particularly for
  ...
  \ref{graph_euler}\footnote{See Kiusalaas {[}32{]}}, we then have:
  \begin{align*}
  ...
  to discretize the latter {[}16,29{]}:
  \begin{align}
  ...
  structures. Another common way {[}33--35{]} to write down the system is
  using the property presented in subsection \ref{corr} as in equation
  \eqref{eq:heston2}.
  \begin{align}
  \label{eq:heston2}
  \begin{split}
  dS_t &= r S_t dt + \rho \sqrt{V_t} dB_t + \sqrt{1 - \rho^2} \sqrt{V_t} S_t dW_t \\
  ...
  1993 Steven Heston's paper {[}23{]} and is described below {[}36{]}:
  \begin{align}
  ...
  a strike price \(K\), that expires at time \(T\) {[}36{]}:
  \begin{align} 
  \label{eq:cfheston}
  \begin{split}
  ...
  (and compare to other similar schemes) {[}33{]} along with some insights
  ...
  computation of \(\sqrt{V_t}\) impossible {[}34{]}. There are several
  ...
  method {[}34,35{]} that coupled with the implicit Milstein scheme for
  ...
  proposed in Andersen {[}34{]}, where a truncation similar to the Euler's
  ...
  In 2006, Broadie-Kaya {[}33{]} propose a method that has a faster
  ...
  of the terminal stock price based on numerous papers {[}23{]}. The stock
  ...
  chi-squared distribution {[}22,40{]}:
  ...
  Broadie and Kaya {[}33{]} sample generating Poisson and gamma
  distributions as in Johnson et al. {[}41{]}. We used the built-in
  ...
  After generating \(V_t\), we follow the instructions in {[}33,41{]}. We
  ...
  use the Bessel package {[}42{]} that accounts for complex numbers. Once
  ...
  The probability distribution function is obtained in {[}33,40{]} by
  Fourier inversions using Feller {[}43{]}. We use the approach in
  Gil-Pelaez {[}44{]}, equation \eqref{eq:fourier}. We define \(V(u,t)\) the
  ...
  solution is called \emph{drift interpolation} {[}45{]} and its
  ...
  Heston {[}23{]} gives a closed form used as benchmark and as the `true'
  ...
  \emph{callHestoncf} belonging to the package NMOF {[}46{]}. Parameters
  ...
  from Table 2 of the Broadie-Kaya {[}33{]} paper, with two minor
  ...
  paper {[}33{]}, Table 2 with two slight changes. We reduced the time to
  ...
  \end{align*}
  However, the Broadie-Kaya paper {[}33{]} presents it as a power series:
  \begin{align*}
  ...
  {[}8{]} Tong, Z. Option pricing with long memory stochastic volatility
  models. 2012.
  ...
  {[}19{]} Engle, R.F. Autoregressive conditional heteroscedasticity with
  ...
  {[}21{]} Hagan, P.S.; Kumar, D.; et al. Arbitrage-free sabr. Wilmott, v.
  2014, n. 69, p. 60--75, 2014.
  
  \hypertarget{ref-cox1985theory}{}
  {[}22{]} Cox, J.C.; Ingersoll Jr, J.E.; et al. A theory of the term
  ...
  {[}23{]} Heston, S.L. A closed-form solution for options with stochastic
  volatility with applications to bond and currency options. Review of
  financial studies, v. 6, n. 2, p. 327--343, 1993.
  
  \hypertarget{ref-gilli_numerical_2011}{}
  {[}24{]} Gilli, M.; Maringer, D.; et al. Numerical methods and
  ...
  {[}26{]} Iserles, A. A first course in the numerical analysis of
  differential equations. 2009.
  
  \hypertarget{ref-burden2001}{}
  {[}27{]} Burden, R.L.; Faires, J.D. Numerical analysis. 2001.
  Brooks/Cole, USA, 2001.
  
  \hypertarget{ref-lambers}{}
  {[}28{]} Lambers, J.V.; Sumner, A.C. Explorations in numerical analysis.
  University o California at Irvine, 2016.
  
  \hypertarget{ref-higham2001}{}
  {[}29{]} Higham, D.J. An algorithmic introduction to numerical
  simulation of stochastic differential equations. SIAM review, v. 43, n.
  3, p. 525--546, 2001.
  
  \hypertarget{ref-clements1973well}{}
  {[}30{]} Clements, D.; Anderson, B. Well-behaved itô equations with
  ...
  {[}31{]} Clark, J.M., Cameron, R. The maximum rate of convergence of
  ...
  {[}32{]} Kiusalaas, J. Numerical methods in engineering with python 3.
  2013.
  
  \hypertarget{ref-broadie2006exact}{}
  {[}33{]} Broadie, M.; Kaya, Ö. Exact simulation of stochastic volatility
  and other affine jump diffusion processes. Operations research, v. 54,
  n. 2, p. 217--231, 2006.
  
  \hypertarget{ref-andersen}{}
  {[}34{]} Andersen, L.B. Efficient simulation of the heston stochastic
  volatility model. 2007.
  
  \hypertarget{ref-kahl2006fast}{}
  {[}35{]} Kahl, C.; Jäckel, P. Fast strong approximation monte carlo
  schemes for stochastic volatility models. Quantitative Finance, v. 6, n.
  6, p. 513--536, 2006.
  
  \hypertarget{ref-dunn2014estimating}{}
  {[}36{]} Dunn, R.; Hauser, P.; et al. Estimating option prices with
  heston's stochastic volatility model. 2014.
  
  \hypertarget{ref-scott1996}{}
  {[}37{]} Scott, L. Simulating a multi-factor term structure model over
  ...
  {[}38{]} Willard, G.A. Calculating prices and sensitivities for
  ...
  {[}39{]} Romano, M.; Touzi, N. Contingent claims and market completeness
  in a stochastic volatility model. Mathematical Finance, v. 7, n. 4, p.
  399--412, 1997.
  
  \hypertarget{ref-baldeaux}{}
  {[}40{]} Baldeaux, J.; Platen, E. Functionals of multidimensional
  diffusions with applications to finance. 2013.
  
  \hypertarget{ref-johnson1995}{}
  {[}41{]} Johnson, N.L.; Kotz, S.; et al. Continuous univariate
  ...
  {[}42{]} Maechler, M. Bessel: Bessel -- bessel functions computations
  and approximations. 2013.
  
  \hypertarget{ref-feller1971introduction}{}
  {[}43{]} Feller, W. Introduction to the theory of probability and its
  applications, vol. 2. II (2. Ed.) New York: Wiley, 1971.
  
  \hypertarget{ref-gil1951note}{}
  {[}44{]} Gil-Pelaez, J. Note on the inversion theorem. Biometrika, v.
  38, n. 3-4, p. 481--482, 1951.
  
  \hypertarget{ref-van2010efficient}{}
  {[}45{]} Van Haastrecht, A.; Pelsser, A. Efficient, almost exact
  ...
  {[}46{]} Schumann, E. Numerical methods and optimization in finance
