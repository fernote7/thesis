...
% Everything below added by CII
  ...
  worrying: (1). This \texttt{Molina1994} entry appears in a file called
  \texttt{thesis.bib} in the \texttt{bib} folder. This bibliography
  database file was created by a program called BibTeX. You can call this
  file something else if you like (look at the YAML header in the main
  .Rmd file) and, by default, is to placed in the \texttt{bib} folder.
  
  For more information about BibTeX and bibliographies, see our CUS site
  (\url{http://web.reed.edu/cis/help/latex/index.html})\footnote{(2)}.
  ...
  \item
    You can add a Reed Thesis citation\footnote{(3)} option. The best way
    to do this is to use the phdthesis type of citation, and use the
    optional ``type'' field to enter ``Reed thesis'' or ``Undergraduate
    thesis.''
  \end{itemize}
  ...
  1 MOLINA, S.T., BORKOVEC, T.D. The Penn State worry questionnaire:
  Psychometric properties and associated characteristics. In: GCL DAVEY, F
  TALLIS (Ed.); \textbf{Worrying: Perspectives on theory, assessment and
  treatment}. New York: 1994, p. 265--283.
  
  \hypertarget{ref-reedweb2007}{}
  Reed~College (2007). LaTeX your document.
  
  \hypertarget{ref-noble2002}{}
  Noble, S.G. (2002). Turning images into simple line-art.
  
  \hypertarget{ref-angel2000}{}
  4 ANGEL, E. \textbf{Interactive computer graphics : A top-down approach
  with opengl}. Boston, MA: 2000.
  
  \hypertarget{ref-angel2001}{}
  5 ANGEL, E. \textbf{Batch-file computer graphics : A bottom-up approach
  with quicktime}. Boston, MA: 2001.
  
  \hypertarget{ref-angel2002a}{}
  6 ANGEL, E. \textbf{Test second book by angel}. Boston, MA: 2001.
