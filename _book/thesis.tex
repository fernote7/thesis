...
% Everything below added by CII
  ...
  process}. These processes generally have a continuous paths {[}3{]}. We
  ...
  Brownian motion from molecular-kinetic theory of heat {[}2,4{]}.
  ...
  {[}5,6{]}.\footnote{More can be found on {[}5--7{]}.}
  ...
  increments and its solution is presented below{[}10{]}:
  \begin{align}
  ...
  {[}6,8{]}. For practical uses you should write out a second-order Taylor
  ...
  the risk-neutral measure with the following dynamics {[}5,15{]}:
  \begin{align}
  dS_{t} = (r-q)S_td_t+\sigma S_t dW_t
  \end{align}
  \noindent
  Where \(dW_t\) is a Wiener process {[}1,15{]}, \(r\) is the risk free
  ...
  risk. The dynamics are described as follows{[}16,17{]}:
  \begin{align}
  \label{eq:cir}
  ...
  term structure{[}16{]}. Furthermore, this equation constitutes one of
  ...
  we can rewrite the first equation as in Broadie and Kaya {[}19{]}:
  \begin{align}
  \label{eq:heston2}
  \begin{split}
  ...
  1993 Steven Heston's paper {[}17{]} and is described below {[}20{]}:
  \begin{align}
  ...
  a strike price \(K\), that expires at time \(T\) {[}20{]}:
  \begin{align} 
  \label{eq:cfheston}
  \begin{split}
  ...
  We present here the Euler Scheme - Full Truncation algorithm {[}19{]}
  along with some insights on how it was implemented in the R programming
  language {[}21{]}. The Euler discretization brings approximation paths
  ...
  computation of \(\sqrt{V_t}\) impossible {[}22{]}. There are several
  ...
  {[}3{]} P.A. de Maio, others, Um método de linearização local com passo
  ...
  {[}5{]} A.D. Helgadóttir, L. Ionescu, Option pricing within the heston
  model, (2016).
  ...
  {[}9{]} R.S. Tsay, Analysis of financial time series, John Wiley \&
  Sons, 2005.
  
  \hypertarget{ref-iacus2009simulation}{}
  {[}10{]} S.M. Iacus, Simulation and inference for stochastic
  differential equations: With r examples, Springer Science \& Business
  Media, 2009.
  
  \hypertarget{ref-steele2012stochastic}{}
  {[}11{]} J.M. Steele, Stochastic calculus and financial applications,
  Springer Science \& Business Media, 2012.
  
  \hypertarget{ref-yang2013valuing}{}
  {[}12{]} Y. Yang, Valuing a european option with the heston model,
  (2013).
  
  \hypertarget{ref-salomao2011precificaccao}{}
  {[}13{]} M. de F. Salomão, Precificação de opções financeiras: Um estudo
  sobre os modelos de black scholes e garch, (2011).
  
  \hypertarget{ref-merton1973theory}{}
  {[}14{]} R.C. Merton, Theory of rational option pricing, The Bell
  ...
  {[}16{]} J.C. Cox, J.E. Ingersoll Jr, S.A. Ross, A theory of the term
  ...
  {[}19{]} M. Broadie, Ö. Kaya, Exact simulation of stochastic volatility
  and other affine jump diffusion processes, Operations Research. 54
  (2006) 217--231.
  
  \hypertarget{ref-dunn2014estimating}{}
  {[}20{]} R. Dunn, P. Hauser, T. Seibold, H. Gong, Estimating option
  ...
  {[}22{]} L.B. Andersen, Efficient simulation of the heston stochastic
