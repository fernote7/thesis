...
% Everything below added by CII
  ...
  increments and its solution is presented below{[}15{]}:
  \begin{align}
  ...
  \end{align}
  \noindent
  Where \(dW_t\) is a Wiener process {[}12,16{]}, \(r\) is the risk free
  ...
  moves and large moves by large moves. {[}3,10{]}
