...
% Everything below added by CII
  ...
  drift interpolated exact algorithm (EA-DI). Clearly, from Figure
  \ref{modcomp1}, all three implementations produce bias (true option
  value is the black vertical line).
  \begin{table}[ht]
  \centering
  \begin{tabular}{lrrrr}
    \hline 
  ...
  \caption{Comparison between models \label{modcomp1}}\label{fig:results10k}
  \end{figure}
  \begin{table}[ht]
  \centering
  \begin{tabular}{lrrrr}
