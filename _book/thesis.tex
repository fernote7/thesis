...
% Everything below added by CII
  ...
  the stock prices as a brownian motion with drift. Later in time, Black
  and Scholes {[}1{]} improved on Bachelier's work designing a model based
  on the geometric brownian motion, a more realistic approach.
  ...
  The Black-Scholes model, once the standard way of option pricing, was
  replaced by stochastic process theories in modern financial analysis.
  These are now prevalent in the academic and real-trading markets.
