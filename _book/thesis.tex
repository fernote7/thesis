...
% Everything below added by CII
  ...
  Samuelson and others modeled the expected discounted payoff of European
  options, but with no standard discount factor or growth rate. In 1973,
  Black and Scholes {[}1{]} designed a model based on the Geometric
  Brownian Motion to price options that became the \emph{de facto}
  ...
  \begin{itemize}  
    \item The process is Markovian. This means that the conditional expectation of $W_{t+\Delta t}$ given its entire history is equal to the conditional expectation of $W_{t+\Delta t}$ given today's information. This can be written as: $E[W_{t+\Delta t}|W_1, ..., W_t] = E[W_{t+\Delta t}|W_t]$.
  ...
  and other models, like the GARCH\footnote{generalized autoregressive
    ...
    beta, rho. {[}19{]}} are considered standard smile models.
  \begin{figure}
  ...
  risk. The dynamics are described as follows {[}20,21{]}:
  \begin{align}
  \label{eq:cir}
  ...
  term structure{[}20{]}. Furthermore, this equation constitutes one of
  ...
  under the risk-neutral measure {[}21,22{]}:
  \begin{align}
  \label{eq:heston}
  ...
  According to Kloeden {[}23{]}, in the stochastic realm, simulated sample
  ...
  solved explicitly {[}23{]}. Hence, stability studies begin with
  ...
  \end{itemize}
  Examples of these two classes of problem can be found in {[}22{]}.
  ...
  Or, as stated in Kloeden {[}23{]}, the suitable values of the stepsize
  ...
  Without entering all the details, for these we recommend {[}23,28,30{]},
  ...
  1993 Steven Heston's paper {[}21{]} and is described below {[}34{]}:
  \begin{align}
  ...
  \begin{align}
  S_{t\Delta} = S_t + rS_t + \sqrt{V_t} S_t Z_s
  \end{align}
  \noindent
  And for the variance process:
  \begin{align}
  V_{t\Delta} = f_1(V_{t}) + \kappa (\theta - f_2(V_{t})) + \sigma \sqrt{f_3(V_{t})} Z_v 
  \end{align}
  \noindent
  ...
  of the terminal stock price based on numerous papers {[}21{]}. The stock
  ...
  chi-squared distribution {[}20,38{]}:
  ...
  Heston {[}21{]} gives a closed form used as benchmark and as the `true'
  ...
  {[}19{]} Hagan, P.S.; Kumar, D.; et al. Arbitrage-free sabr. Wilmott, v.
  2014, n. 69, p. 60--75, 2014.
  
  \hypertarget{ref-cox1985theory}{}
  {[}20{]} Cox, J.C.; Ingersoll Jr, J.E.; et al. A theory of the term
  ...
  {[}21{]} Heston, S.L. A closed-form solution for options with stochastic
  volatility with applications to bond and currency options. Review of
  financial studies, v. 6, n. 2, p. 327--343, 1993.
  
  \hypertarget{ref-gilli_numerical_2011}{}
  {[}22{]} Gilli, M.; Maringer, D.; et al. Numerical methods and
  optimization in finance. 2011.
  
  \hypertarget{ref-kloeden1992}{}
  {[}23{]} Kloeden, P.E.; Platen, E. Numerical solution of stochastic
