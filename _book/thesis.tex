...
% Everything below added by CII
  ...
  \begin{tabular}{lrrrr}
    \hline 
  Simulations & Euler & Kahl & EA\_BK & EA\_mod \\ 
    \hline 
  ...
  \begin{tabular}{lrrrr}
    \hline 
  simulations & euler & Kahl & EA\_BK & mod\_EA \\ 
    \hline 
  ...
  Firstly, we provided a succint, but rigorous, literature review. Since
  this topic is very embracing, we provided an abundant amount of
  ...
  algorithm''. The first trying to bem as similar as possible to the one
  presented in Broadie-Kaya's paper and the modified version bringing an
  approximation to the algorithm's second step (the costlier step).
