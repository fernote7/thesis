...
euler = c(14.97, 14.16424, 14.11025)

N=10000 ("user system elapsed 113.219   8.617 130.527")
N=100000("user system  elapsed 1803.148  113.230 1923.812")

kj = c(13.05, 13.86, 13.83)
ea = c(14.71165, 14.44851,14.20904)
