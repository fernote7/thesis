...
result1 <- data.frame("Simulations" = c("1,000", "10,000", "100,000"), "Euler" = euler, "Kahl" = kj, "EA_BK" = ea_bk, "EA_DI" = ea_mod, row.names = NULL)
...
print(xtable::xtable(result1, caption = "Option Value", label = "res"), 
