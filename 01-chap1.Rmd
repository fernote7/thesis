...
This process is used quite often in finance to model the dynamics of some assets becaus of its properties. It has independent multiplicative increments and is the procee used to price options in the Black-Scholes model [@iacus2009simulation]:
