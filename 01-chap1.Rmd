...
A stochastic process $S_t$ is a Geometric Brownian Motion ^[There is an Arithmetic Brownian Motion: $dS_t = \mu dt + \sigma dB_t$. More information can be obatined at [@ubbo].] if it is described by the solution of the following stochastic differential equation [@ubbo; @tong2012option; @tsay2005analysis].
