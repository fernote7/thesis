...
```{r stab2, echo=FALSE, message=FALSE, results='asis', fig.height=3, fig.width = 6.5, fig.align='center', fig.cap='Stability domains \\label{stab2}'}
