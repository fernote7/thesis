...
There are two major different option types: the European and the American. The difference between these two is that the bearer of the first may excercise it only at the end of its life, at its maturity while the latter can be excercised at any given time until its maturity. [@black1973pricing; @merton1973theory]
...
<!-- ''' [@yang2013valuing] -->
<!-- Although Black-Scholes equation is still widespread used in the market, much evidence has shown that -->
<!-- the assumption of fixed volatility is not suitable for actual data. we -->
<!-- consider the volatility following a stochastic process rather than a constant during the life of a call option. -->
<!-- ''' -->
