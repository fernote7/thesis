...
The second equation, as previously described, is the CIR model equation. The first equation states the asset price process. $\mu$ is the asset's rate of return,  $dW^1_t$ and $dW^2_t$ are two correlated wiener processes with correlation coefficient of $\rho$.


<!-- **TODO:MODEL REWRITTEN HERE** -->
