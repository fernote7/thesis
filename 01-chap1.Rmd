...
In 1923, the Wiener process was coined in honor of Norbert Wiener mathematical proof of existence of the brownian motion.

\footnotesize

*  $W_{0}=0$ 
*  $W$ has independent increments: $W_{t+u}-W_{t}$ is independent of $\sigma \left(W_{s}:s\leq t\right)$ for $u~\geq 0$
