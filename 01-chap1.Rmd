...
This ``noise''  $dW_t$ is a Wiener process (which will be clarified below) and $X_0$ is ou initial value. The solution to this class of SDE is often referred as a *diffusion process*. These processes generally have a continuous paths.
