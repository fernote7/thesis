...
```{r results10k, echo=FALSE, message=FALSE, results='asis', fig.asp = 1.2, fig.width = 5, fig.align='center', fig.cap='Comparison between models \\label{modcomp1}'}
