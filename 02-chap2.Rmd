...
where $\gamma(a) = \sqrt{\kappa^2 - 2 \sigma^2 i a}$, $\delta$ was previously defined and $I_v(x)$ is the modified Bessel function of the first kind ^[\textit{See Appendix  \@ref(bessel) for more information.}].
